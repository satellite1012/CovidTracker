...
<div class="row">
    ...
    font-weight: 700;
    color: cyan;">
			<li><i class="fa fa-home"></i><a style="color:white" href="<c:url value='/trang-chu'/>">Data Analysis by <span style="color:orangered">HTH Team</span> using R</a></li>
		</ol>
	</div>
</div>
	...
	<section id="headsection">
		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="panel-heading">
				<h2>
					<i class="fa fa-flag-o red"></i><strong>Threat Zone City Level (Da Nang)&nbsp;&nbsp;|&nbsp;&nbsp;<span class="mytext">Sync on HTH's GitHub by R Algorithm base on GOV</span></strong>
				</h2>
			...
			<div class="panel-body-map" >
				<div class="img-responsive">
					<img style="width: 100%;height: 100%" src="https://raw.githubusercontent.com/quanghien1712/Covid-Image/master/dana.png" alt="None">
				</div>
			</div>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><hr style="border-top: 2px solid #2b2b2b47;"><br>
