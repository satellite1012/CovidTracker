		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>
						<i class="fa fa-flag-o red"></i><strong>All City in Vietnam have COVID-19&nbsp;&nbsp;|&nbsp;&nbsp;<span class="mytext">Update frequently on HTH's Database base on GOV </span></strong>
					</h2>
				...
				<div class="panel-body-map">
					...
					<iframe src="https://public.domo.com/cards/zppy8" width="100%" height="900px" marginheight="0" marginwidth="0" frameborder="0"></iframe>
					</div></div>
			</div>
