		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="panel-heading">
				<h2>
					...
					<i class="fa fa-map-marker red"></i><strong>Nearest Day&nbsp;&nbsp;|&nbsp;&nbsp;<span class="mytext">Update frequently on HTH's Database base on GOV </span></strong>
				</h2>
				...
				<div class="panel-body-map" >
					<div class="embed-responsive">
						<iframe src="https://public.domo.com/cards/qxxr2" width="100%" height="600" marginheight="0" marginwidth="0" frameborder="0"></iframe>
					</div>
				</div>
...
<script>
	document.getElementsByClassName('_2y8CdaR3ybdEhXc5GueK9w').length
</script>
