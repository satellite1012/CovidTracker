...
<div class="row">
    ...
    font-weight: 700;
    color: cyan;">
			<li><i class="fa fa-home"></i><a style="color:white" href="<c:url value='/trang-chu'/>">Threat Zone Country Level (Viet Nam) | by <span style="color:orangered">HTH Team</span> using R</a></li>
		</ol>
	</div>
</div>
		...
		<section id="headsection">
			...
			<div class="col-md-4 col-xs-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h2>
							<i class="fa fa-flag-o red"></i><strong><span class="mytext">Sync on HTH's GitHub by R Algorithm base on GOV</span></strong>
						</h2>
					...
					<div class="panel-body-map" >
						<div class="img-responsive">
							<img style="width: 100%;height: 60%" src="https://raw.githubusercontent.com/quanghien1712/Covid-Image/master/vietnam.png" alt="None">
						</div>
					</div>
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h2>
							<i class="fa fa-flag-o red"></i><strong>Cities Details (Viet Nam)&nbsp;&nbsp;|&nbsp;&nbsp;<span class="mytext">Update frequently from HTH's Database base on GOV</span></strong>
						</h2>
						<div class="panel-actions">
							<a onclick='success1()' class="btn-setting"><i
									class="fa fa-rotate-right"></i></a>
					...
					<div class="panel-body-map" >
						<div class="embed-responsive">
							<iframe src="https://public.domo.com/cards/W66rX" width="100%" height="780" marginheight="0" marginwidth="0" frameborder="0"></iframe>
						</div>
					</div>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><hr style="border-top: 2px solid #2b2b2b47;"><br>
